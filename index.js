const  XBOT = 'ZULFAN'; // Nama Bot Whatsapp
const instagram = 'https://instagram.com/Zulfan_1703'; // Nama Instagramlu cok
const nomer = 'https://Wa.me/+6282228448960'; // Nomor whatsapplu cok
const aktif = 'Tergantung kuota'; // Kapan bot lu aktif
const groupwa = 'comming soon'; // OFFICIAL GRUP LU 1
const youtube = 'https://youtube.com/channel/UCbExBcr1UCCFeB8EYgWaCFg'; 
...
const vcard = 'BEGIN:VCARD\n' // metadata of the contact card
            ...
            + 'TEL;type=CELL;type=VOICE;waid=6282228448960:+62 822-2844-8960\n' // WhatsApp ID + phone number
            + 'END:VCARD'
